...
func seedSnapshot(t *testing.T, path string) *snapshot.Snapshot {
	...
	s := &snapshot.Snapshot{
		...
		Candidates: []snapshot.Candidate{
			{Slug: "cheap-low", Name: "Cheap Low", Quality: 30, InputPricePer1M: 0, OutputPricePer1M: 4, BlendedPricePer1M: 1, Provider: "artificial-analysis"},
			{Slug: "mid", Name: "Mid", Quality: 45, InputPricePer1M: 4, OutputPricePer1M: 16, BlendedPricePer1M: 7, Provider: "artificial-analysis"},
			{Slug: "pricey-top", Name: "Pricey Top", Quality: 60, InputPricePer1M: 20, OutputPricePer1M: 40, BlendedPricePer1M: 25, Provider: "artificial-analysis"},
		},
